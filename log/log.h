...
class Log {
  public:
    ...
    bool last_cleaning_fail(void) const;//whether last cleaning has a failure; true=flash is almost full
  ...
  private:
    ...
    void set_flash(Flash* value) { this->flash_ = value; }

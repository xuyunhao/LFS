...
TEST(FlashTest, VFlash) {

  const uint16_t noctet_sector = FLASH_SECTOR_SIZE;
  const FlashSectorNum nsector = 100000;
  FlashSectorNum sector1 = 7;
  uint8_t buf11[noctet_sector * 2];
  uint8_t buf12[noctet_sector * 2];
  FlashSectorNum sector2 = 15;

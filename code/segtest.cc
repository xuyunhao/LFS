...
int main(){
	...
	Segment * test_seg = new Segment(flash, 1, 0, 1, 32, FLASH_SECTORS_PER_BLOCK, 1000, NULL);
	...
	std::cout << "333333" << std::endl;
	Segment * test_read = new Segment(fptr, 0, 1, 32, FLASH_SECTORS_PER_BLOCK, 1000);
	std::cout << "444444" << std::endl;
	std::cout << (test_read->get_blk(1) == NULL) << std::endl;
	return 0;
}
